...
object Main {
  ...
  private def usage(): Unit = {
    ...
    System.err.println("[-database_from2=<name>]  - MongoDB database name, by default, will be the database_from1")
    System.err.println("[-database_out=<name>]    - MongoDB database name, by default, will be the database_from1")
